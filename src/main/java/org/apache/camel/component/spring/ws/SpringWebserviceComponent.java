...
public class SpringWebserviceComponent extends DefaultComponent {
    ...
    private void addEndpointMappingToConfiguration(Map<String, Object> parameters, SpringWebserviceConfiguration configuration) {
        ...
        if (endpointMapping == null && configuration.getEndpointDispatcher() == null) {
            throw new RuntimeCamelException("No CamelEndpointMapping found in Spring ApplicationContext. This bean is required " + "for Spring-WS consumer support (unless the 'springws:beanname:' URI scheme is used)");
        }

...
/**
 * A helper class to transform to and from {@link StringSource} implementations
 ...
 * however a chance that you may end up with incompatible {@link StringSource}
 * implementations, this converter handles these (corner)cases.
 * 
 * Note that conversion options are limited by Spring's {@link StringSource}

...
public class ConsumerEndpointMappingRouteTest extends CamelSpringTestSupport {
	...
	private static final SourceExtractor noopSourceExtractor = new SourceExtractor() {
	...
	public void testRootQName() throws Exception {
		...
		webServiceTemplate.sendSourceAndReceive(source, noopSourceExtractor);
	...
	public void testSoapAction() throws Exception {
		...
		webServiceTemplate.sendSourceAndReceive(source, new SoapActionCallback("http://www.stockquotes.edu/GetQuote"), noopSourceExtractor);
	...
	public void testWrongSoapAction() throws Exception {
		StreamSource source = new StreamSource(new StringReader(xmlRequestForGoogleStockQuoteNoNamespace));
		webServiceTemplate.sendSourceAndReceive(source, new SoapActionCallback("http://this-is-a-wrong-soap-action"), noopSourceExtractor);
	...
	public void testUri() throws Exception {
		StreamSource source = new StreamSource(new StringReader(xmlRequestForGoogleStockQuoteNoNamespace));
		webServiceTemplate.sendSourceAndReceive("http://localhost/stockquote2", source, noopSourceExtractor);
	...
	protected AbstractXmlApplicationContext createApplicationContext() {
		return new ClassPathXmlApplicationContext(new String[] {"org/apache/camel/component/spring/ws/ConsumerEndpointMappingRouteTest-context.xml"});
	}
}

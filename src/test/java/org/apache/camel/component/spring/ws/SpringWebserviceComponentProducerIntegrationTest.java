...
public class SpringWebserviceComponentProducerIntegrationTest extends CamelSpringTestSupport {
	...
	protected AbstractXmlApplicationContext createApplicationContext() {
		return new ClassPathXmlApplicationContext(new String[] {"org/apache/camel/component/spring/ws/SpringWebserviceComponentProducerIntegrationTest-context.xml"});
	}
}
